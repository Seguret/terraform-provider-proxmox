# proxmox_virtual_environment_vm_rrd (Data Source)

Retrieves RRD performance data for a Proxmox VE virtual machine.
...
```hcl
data "proxmox_virtual_environment_vm_rrd" "example" {
  node_name = "pve"
  vmid      = 100
  timeframe = "hour"
}
