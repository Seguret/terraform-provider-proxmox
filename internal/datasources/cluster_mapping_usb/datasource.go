...
func (d *DataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_cluster_mapping_usb"
}

func (d *DataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "Retrieves USB hardware mappings from the cluster.",
		...
		Attributes: map[string]schema.Attribute{
			...
			"mappings": schema.ListNestedAttribute{
				MarkdownDescription: "List of USB hardware mappings.",
				Computed:            true,
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						...
						"map": schema.ListAttribute{
							MarkdownDescription: "List of USB device mappings.",
							Computed:            true,
...
func (d *DataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	mappings, err := d.client.GetHardwareMappingUSB(ctx)
	if err != nil {
		resp.Diagnostics.AddError("Client Error", "Failed to retrieve USB mappings: "+err.Error())
		return
	}

	data.ID = types.StringValue("cluster_mapping_usb")
